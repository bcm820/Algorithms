...
// If a year is divisible by four, it is a leap year, unless divisible by 100.
...
// Exclude 0. Don't use a FOR loop.
...
// e.g. For (2, 9, 3), print 9 6 3 on consecutive lines.
...
// of param1, starting at param2 and extending to param3. Use a WHILE.
// One exception: if a multiple is equal to param4, then skip (don't print).
// e.g. (3,5,17,9) prints 6,12,15 (multiples of 3 between 5 and 17, excluding 9).
...
// Countdown
// Create a function that accepts a number input.
...
// First Plus Length
// Given an array, return the sum of the first value in the array and its length.
// What happens if the array's first value is not a number (e.g. string, boolean)?
...
// Given an array, return a new array with values greater than its 2nd value.
// Print how many values this is. What if the array is only one element long?
